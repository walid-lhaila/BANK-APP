                ...
                while($row = mysqli_fetch_array($result)){
                  echo "<tr>                            
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href='delettransaction.php?id={$row["id"]}' class='font-bold text-white h-8 rounded  cursor-pointer px-2 bg-red-700 shadow-md transition ease-out duration-500 border-red-700 '>DELET</a>
                                                        </td>
                                                        </tr>";

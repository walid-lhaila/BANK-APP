...
<div class="relative ml-[40px] top-10">
    <table class="w-[900px] text-center text-sm text-left rtl:text-right text-gray-200 dark:text-gray-200">
               ...
               if($result){
                while($row = mysqli_fetch_array($result)){
                  ...
                  <td>
                            ...
                            <a href='delet_bank.php?id={$row["id"]}' class='font-bold text-white h-8 rounded  cursor-pointer px-2 bg-red-700 shadow-md transition ease-out duration-500 border-red-700 '>DELET</a>
                  </td>
                  </tr>";
                }
                echo "</tbody></table>";
